  ...
  return (
    <section className="mx-auto max-w-7xl">
      <div className="my-10 text-center">
        <h1 className="font-serif text-4xl font-bold text-not-that-black xs:text-6xl lg:text-8xl">
          The Community Showcase
        </h1>
        <p className="text-md mt-2 font-sans font-medium text-sky-blue xs:text-lg lg:text-xl">
          Browse through a collection of imaginative and visually stunning
          images generated by
        </p>
        <p className="mt-2 text-2xl font-extrabold tracking-wider text-not-that-black lg:text-4xl">
          <Typewriter
            options={{
              strings: "DALL-E",
              autoStart: true,
